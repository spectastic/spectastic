...
<spec-screen id="convert"><spec-state id="idle" source="authored"></spec-state></spec-screen>
<spec-screen id="pairs"><spec-state id="idle" source="authored"></spec-state></spec-screen>
<spec-screen id="convert-unmapped"><spec-state id="idle" source="authored"></spec-state></spec-screen>
</main></body></html>`;
...
describe('visual-screen-naming (093 FR-014/FR-015)', () => {
  ...
  it('merges screens across several files in a declared directory', async () => {
    ...
    writeFileSync(
      ...
      `<!doctype html><html><body><main><spec-screen id="settings"></spec-screen></main></body></html>`,
      'utf8',
    );
