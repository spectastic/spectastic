 ...
 */
const DEFAULT_IGNORE = ['**/node_modules/**', '**/dist/**', '**/archive/**', '**/withdrawn/**'];

/**
 * Expand the given glob patterns to a sorted list of file paths,
 * applying default + user-supplied ignore patterns.
 */
export async function expandGlobs(patterns: readonly string[], extraIgnore?: readonly string[]): Promise<string[]> {
